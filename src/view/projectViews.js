...
router.put("/update/:projectId", passport.authenticate("jwt", {session: false}), project.update)
router.delete("/delete/:projectId", passport.authenticate("jwt", {session: false}), project.delete)
